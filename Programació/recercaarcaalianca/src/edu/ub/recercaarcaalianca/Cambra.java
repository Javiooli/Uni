...
public class Cambra implements Renderable {
    ...
    private static final int BLOCK_COL1 = 3;
    private static final int BLOCK_COL2 = 4;
    private static final int BLOCK_COL3 = 5;
    private static final int BLOCK_COL4 = 6;
            ...
            for (int j = 0; j < arr.length; j++) {
                ...
                switch (c) {
                    case Constants.SIMBOL_MUR:
                        g.drawImage(blocImage[BLOCK_MUR], x, y, Constants.AMPLADA_CELA, Constants.ALCADA_CELA, observer);
                        break;
                    case Constants.SIMBOL_PORTA:
                        g.drawImage(blocImage[BLOCK_PORTA], x, y, Constants.AMPLADA_CELA, Constants.ALCADA_CELA, observer);
                        break;
                    case Constants.SIMBOL_TERRA:
                        g.drawImage(blocImage[BLOCK_TERRA], x, y, Constants.AMPLADA_CELA, Constants.ALCADA_CELA, observer);
                        break;
                    case Constants.SIMBOL_COL1:
                        g.drawImage(blocImage[BLOCK_COL1], x, y, Constants.AMPLADA_CELA, Constants.ALCADA_CELA, observer);
                        break;
                    case Constants.SIMBOL_COL2:
                        g.drawImage(blocImage[BLOCK_COL2], x, y, Constants.AMPLADA_CELA, Constants.ALCADA_CELA, observer);
                        break;
                    case Constants.SIMBOL_COL3:
                        g.drawImage(blocImage[BLOCK_COL3], x, y, Constants.AMPLADA_CELA, Constants.ALCADA_CELA, observer);
                        break;
                    case Constants.SIMBOL_COL4:
                        g.drawImage(blocImage[BLOCK_COL4], x, y, Constants.AMPLADA_CELA, Constants.ALCADA_CELA, observer);
                        break;
                    default:
                        // per ara, res ...
                }
    ...
    private void init() {
        blocImage = new Image[7];
        blocImage[BLOCK_MUR] = Util.carregarImatge("mur32.png");
        blocImage[BLOCK_TERRA] = Util.carregarImatge("terra32.png");
        blocImage[BLOCK_PORTA] = Util.carregarImatge("terra32.png");
        blocImage[BLOCK_COL1] = Util.carregarImatge("col1.png");
        blocImage[BLOCK_COL2] = Util.carregarImatge("col2.png");
        blocImage[BLOCK_COL3] = Util.carregarImatge("col3.png");
        blocImage[BLOCK_COL4] = Util.carregarImatge("col4.png");
    }
